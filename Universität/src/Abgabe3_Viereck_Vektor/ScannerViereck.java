...
public class ScannerViereck {
	...
	public static Viereck scan() throws ViereckException {
		...
		//Abfrage, welches Viereck erstellt werden soll
		while (true) {
		...
		//Überprüfung, welches Viereck ausgewählt wurde und Abfrage der vier Punkte
		//des Vierecks
		if (txt == 1 || txt==2 ) {
			...
			try {
				...
				if (txt==1) {
					...
					throw new ViereckException(ViereckException.DATENTYP);
			}
		}
